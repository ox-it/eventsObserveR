...
Pretend creatures species

```{r}
# http://jimpix.co.uk/generators/word-generator.asp#results
pretend_creatures <- c(
  "ant",
  "buffalo",
  "donkey",
...
# eventsObserveR(events = emre_data, place.key = "station", legend = legend.df, legend.columns = 2)
...
replace(emre_data$Species, unique(emre_data$Species), )
